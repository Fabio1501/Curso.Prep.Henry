...
function crearUsuario() {
  ...
  user = new Usuario(obj);
  user.saludar();
  return user;
}

crearUsuario("Fabio", {usuario: "fabio1501", nombre: "Fabian", email: "fabiuuu8@gmail.com", password: "dddd"});
...
let Fabio = new Persona("Fabio","Cara","23","Aguado");
Fabio.detalle();
